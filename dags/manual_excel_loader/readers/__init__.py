...
from .csv_reader import CsvReadConfig, stream_csv
...
def read_file(
    ...
    *,
    ...
    if suffix in _CSV_SUFFIXES:
        ...
        headers, rows_iter = stream_csv(csv_cfg)
        return SheetData(
            headers=headers,
            rows=rows_iter,
            source_path=path,
    ...
    if suffix in _SQL_SUFFIXES:
        sql_cfg = SqlReadConfig(path=path, stream=stream, encoding=encoding)
